...
def ensure_tables_exist(cursor) -> bool:
    ...
    If you want, we can add optional lightweight verification queries that
    check for table existence and warn if a required table is missing, but
    will still not create anything.
    """
